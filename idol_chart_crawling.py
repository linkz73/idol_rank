...
df = pd.DataFrame(columns=['순위', '아이돌', '음원/음반', '유튜브', '전문가/평점랭킹', '방송/포털/소셜', '총점', '순위변화', '아이돌 평점주기', '날짜','img'])
...
for year in range(2018,2020,1):
    ...
    for month in range(1,13):
        ...
        if year == 2019 and month == 12:
            ...
            for page in range(1,6):
                ...
                for span in spans:
                    ...
                    if img_url:
                        ...
                        img = img_url[1]
                        img_s = "https://www.idol-chart.com" + img
            ...
            sub_df = pd.DataFrame(result, columns=['순위', '아이돌', '음원/음반', '유튜브', '전문가/평점랭킹', '방송/포털/소셜', '총점', '순위변화', '아이돌 평점주기', '날짜', 'img'])
            df = df.append(sub_df)
...
# df.to_excel('test_img.xlsx', sheet_name = 'sheet1')
